...
const Home: NextPage<HomeProps> = ({ blogs = [] }) => {
  const meta = {
    ...
    description: `I'm Aswini Rath, a software engineer and an Experimental individual awaiting to metamorphose and hone my technical skills with an eye on meeting the goals of the
    organization. With an experience of meeting the current and envisioned needs by developing creative/modern approaches.`,
    openGraph: {
      images: [
        {
          url: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.shutterstock.com%2Fsearch%2Fprofessional&psig=AOvVaw24JwjeBCoE55KWGvQ5IVOP&ust=1680785671906000&source=images&cd=vfe&ved=0CA8QjRxqFwoTCICc69jkkv4CFQAAAAAdAAAAABAIhttps://og-image.vercel.app/**NEXT.js%20Starter%20Blog**%3Cbr%20%2F%3EStarter%20blog%20with%20MDX%2C%20Tailwind%20CSS%2C%20and%20TypeScript..png?theme=dark&md=1&fontSize=100px&images=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fhyper-bw-logo.svg',
